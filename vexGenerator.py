...
class VexGenerator:
    ...
    def populate_message(self, package_idx: int) -> str:
        ...
        affected_methods = [func.name for func in affected_functions]
        ...
        if reachable:
            ...
            if package_idx == len(self.chain) - 2:
                unreachable_paths = [
